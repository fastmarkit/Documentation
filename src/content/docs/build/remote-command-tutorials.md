...
Because these commands are sent to Misty over a local network connection, you must connect your robot to your local network. [Use the Companion App](../../../docs/guides/companion-app) to connect your robot to your Wi-Fi network, or [follow this guide](../../../docs/guides/api-explorer/#connecting-wi-fi) to connect Misty to your Wi-Fi network using the API Explorer and an Ethernet/USB dongle. Once Misty is connected to your network, take note of her IP address to use with the REST API commands.
