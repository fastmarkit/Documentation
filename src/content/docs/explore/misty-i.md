...
Now that you've put your robot together, you can set up Misty's internet connection with the [Companion app](../../guides/companion-app/).
...
1. Open up the [API Explorer](../../guides/api-explorer) in a browser and connect it to your robot.
...
Misty checks for available system updates every time you turn her on or restart her. If you've not restarted her recently, you can check for and perform updates for Misty with the [Misty Companion app](../../guides/companion-app/#updating-misty) or [API Explorer](../../guides/api-explorer/#system-updates).
