...
For more about events and callbacks, see the [Data Handling: Events & Callbacks](../../../docs/build/local-skill-architecture/#data-handling-events-amp-callbacks) section of [On-Robot JavaScript API Architecture](../../../docs/build/local-skill-architecture).
